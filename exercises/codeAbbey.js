...
// 9 given three lengths, could you build a triangle with them?

/*
  Triangle inequality theorem says the some of any two sides must exceed
  the length of the third side.
*/
function canBuildTriangle(lenOne, lenTwo, lenThree) {
  return lenOne + lenTwo > lenThree ? true: false;
}
...
// 7) divide, round answer to the nearest integer if there's a remainder
function noRemDivide (numOne, numTwo) {
  return round(numOne/numTwo);
}
